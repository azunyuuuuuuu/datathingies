...
namespace datathingies.Data
{
    public record Covid19DataEntry
    {
        ...
        [Name("new_cases_smoothed")] public double? NewCases7DayAverage { get; init; }
        [Name("total_deaths")] public double? TotalDeaths { get; init; }
        [Name("new_deaths")] public double? NewDeaths { get; init; }
        [Name("new_deaths_smoothed")] public double? NewDeaths7DayAverage { get; init; }
        ...
        [Name("new_vaccinations_smoothed")] public double? NewVaccinations7DayAverage { get; init; }
